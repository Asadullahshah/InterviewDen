...
export default function CandidatePortal() {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 dark:bg-slate-900">
      {/* Sidebar */}
      <div className="hidden md:flex w-64 flex-col fixed inset-y-0 z-50 bg-indigo-600 dark:bg-indigo-900">
        <div className="flex h-16 items-center px-4 border-b border-indigo-500 dark:border-indigo-800">
        ...
        <div className="flex-1 overflow-auto py-4">
          <nav className="grid items-start px-2 text-sm font-medium">
            <Button
              variant="ghost"
              className="flex justify-start gap-2 px-3 py-2 h-auto text-indigo-100 hover:text-white hover:bg-indigo-700"
              asChild
            >
        ...
        <div className="p-4 mt-auto">
          <div className="bg-indigo-700 rounded-lg p-4 text-white">
            <h3 className="font-medium flex items-center gap-2 mb-2">
              <Zap className="h-4 w-4" /> AI Assistant
            </h3>
            <p className="text-xs text-indigo-200 mb-3">Get personalized career advice and interview tips</p>
            <Button size="sm" className="w-full bg-white text-indigo-700 hover:bg-indigo-100">
              Ask AI
            </Button>
          </div>
        </div>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-slate-500 dark:text-slate-400">
                              TechCorp Inc. • Tomorrow, 10:00 AM
                            </p>
                          </div>
                        </div>
                        <div className="flex items-center gap-2">
