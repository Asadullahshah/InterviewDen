...
import { PanelLeft, Home, Users, Briefcase, Calendar, FileText, BarChart, HelpCircle, Settings } from "lucide-react"
...
type IconName = "Home" | "Users" | "Briefcase" | "Calendar" | "FileText" | "BarChart" | "HelpCircle" | "Settings"
...
export function SidebarContentOnly({
  className,
  items,
  userType,
      ...
      >
        ...
        >
          ...
          >
            {children ||
              (items && userType && (
                <SidebarContentOnly items={items} userType={userType} aiAssistantTitle={aiAssistantTitle} />
              ))}
          </div>
        </div>
      </div>
